...
/**
 * The MainFrame class makes the GUI for the program. It also includes some test data for quick demonstration
 * 
 * It initializes the models to be used for GUI, the graphs and all GUI elements It also has some action
 * listeners
 */
public class MainFrame extends JFrame {
	...
	public void initTestData1() {
		...
		String[] mmfStrings = new String[] { "A=1=4=0=MMF graph display=", "B=1=6=2=ROI table and NPV display",
				"D=2=5=0=Automatic sorting of MMFs=B", "F=2=4=0=Drag-and-drop MMFs and precursors=A",
				"G=2=7=2=Economical graphs=B", "H=3=6=2=Reports=B,G", "I=2=2=1=Project save/load=",
				"J=3=3=1=Project import/export=I", "K=3=1=1=Copy/paste spreadsheets and MMFs=", "L=3=1=1=Workspace=I" };
		...
		try {
			...
			project.addCategory(new Category("Economical information", TangoColor.SCARLET_RED_1, project.getCategory(0)));
	...
	public void setModel(Project project) {
		...
		// Graphs
		decompositionGraph.setModel(project, GraphCanvas.GRAPH_TYPE_DECOMPOSITION);
	...
	/**
	 * Will be run after initComponents() and is used to set up extra models and renderers.
	 */
	private void postInitComponents() {
		...
		placement.add("projectPropPanel", "Project Properties", TabPanePanelPlacement.TYPE_INPUT,
				TabPanePanelPlacement.PLACEMENT_LOWER, true, projectPropPanel);
		placement.add("mmfTablePanel", "MMF Table", TabPanePanelPlacement.TYPE_INPUT,
				TabPanePanelPlacement.PLACEMENT_LOWER, true, mmfTablePanel);
		placement.add("revenueTablePanel", "MMF Revenue", TabPanePanelPlacement.TYPE_INPUT,
				TabPanePanelPlacement.PLACEMENT_LOWER, true, revenueTablePanel);
		placement.add("decompositionScrollPane", "Decomposition Graph", TabPanePanelPlacement.TYPE_OUTPUT,
				TabPanePanelPlacement.PLACEMENT_UPPER, true, decompositionScrollPane);
		placement.add("precedenceScrollPane", "Precedence Graph", TabPanePanelPlacement.TYPE_OUTPUT,
				TabPanePanelPlacement.PLACEMENT_UPPER, true, precedenceScrollPane);
		placement.add("sanpvTablePanel", "SANPV Table", TabPanePanelPlacement.TYPE_OUTPUT,
				TabPanePanelPlacement.PLACEMENT_LOWER, true, sanpvTablePanel);
		placement.add("sanpvChart", "SANPV Chart", TabPanePanelPlacement.TYPE_OUTPUT,
				TabPanePanelPlacement.PLACEMENT_UPPER, true, sanpvChart);
		placement.add("npvChart", "NPV Chart", TabPanePanelPlacement.TYPE_OUTPUT,
				TabPanePanelPlacement.PLACEMENT_UPPER, true, npvChart);
		placement.add("npvChartWaterfall", "NPV Waterfall Chart", TabPanePanelPlacement.TYPE_OUTPUT,
				TabPanePanelPlacement.PLACEMENT_UPPER, true, npvChartWaterfall);
		placement.add("roiTablePanel", "NPV Table", TabPanePanelPlacement.TYPE_OUTPUT,
				TabPanePanelPlacement.PLACEMENT_LOWER, true, roiTablePanel);
		placement.add("roiWaterfallPanel", "NPV Waterfall Table", TabPanePanelPlacement.TYPE_OUTPUT,
		...
		upperPaneMoveMenuItem
				.setAction(new MoveTabAction(this, upperTabbedPane, TabPanePanelPlacement.PLACEMENT_LOWER));
		...
		lowerPaneMoveMenuItem
				.setAction(new MoveTabAction(this, lowerTabbedPane, TabPanePanelPlacement.PLACEMENT_UPPER));
	...
	private void initComponents() {
		...
		fileLoadProjectsRemotellyDataMenuItem = new javax.swing.JMenuItem();
		...
		periodsTextField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
						...
						.addGroup(
								projectPropPanelLayout
										...
										.addGroup(
												projectPropPanelLayout
														.createParallelGroup(GroupLayout.Alignment.LEADING)
														.addComponent(categoryTableScrollPane,
														...
														.addGroup(
																projectPropPanelLayout
																		...
																		.addComponent(projectNameTextField,
																				...
																				GroupLayout.PREFERRED_SIZE)))
										.addContainerGap()));
		projectPropPanelLayout.setVerticalGroup(projectPropPanelLayout.createParallelGroup(
														...
														.addGroup(
																projectPropPanelLayout
																		...
																		.addComponent(interestRateTextField,
																				...
																				GroupLayout.DEFAULT_SIZE,
																				GroupLayout.PREFERRED_SIZE)))
										.addComponent(maxMmfsPerPeriodTextField, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addComponent(maxMmfsPerPeriodLabel))
						.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(
								projectPropPanelLayout
										.createParallelGroup(GroupLayout.Alignment.LEADING)
										.addComponent(categoryLabel)
										.addComponent(categoryTableScrollPane, GroupLayout.DEFAULT_SIZE, 170,
		...
		mmfTablePanelLayout.setHorizontalGroup(mmfTablePanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(
						mmfTablePanelLayout.createSequentialGroup().addContainerGap()
								.addComponent(mmfTableScrollPane, GroupLayout.DEFAULT_SIZE, 573, Short.MAX_VALUE)
								.addContainerGap()));
		mmfTablePanelLayout.setVerticalGroup(mmfTablePanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(
						GroupLayout.Alignment.TRAILING,
						mmfTablePanelLayout.createSequentialGroup().addContainerGap()
								.addComponent(mmfTableScrollPane, GroupLayout.DEFAULT_SIZE, 248, Short.MAX_VALUE)
								.addContainerGap()));
		...
		revenueTablePanelLayout.setHorizontalGroup(revenueTablePanelLayout.createParallelGroup(
				GroupLayout.Alignment.LEADING).addGroup(
				revenueTablePanelLayout.createSequentialGroup().addContainerGap()
						.addComponent(revenueTableScrollPanel, GroupLayout.DEFAULT_SIZE, 573, Short.MAX_VALUE)
						.addContainerGap()));
		revenueTablePanelLayout.setVerticalGroup(revenueTablePanelLayout.createParallelGroup(
				GroupLayout.Alignment.LEADING).addGroup(
				revenueTablePanelLayout.createSequentialGroup().addContainerGap()
						.addComponent(revenueTableScrollPanel, GroupLayout.DEFAULT_SIZE, 248, Short.MAX_VALUE)
						.addContainerGap()));
		...
		sanpvTablePanelLayout.setHorizontalGroup(sanpvTablePanelLayout.createParallelGroup(
				GroupLayout.Alignment.LEADING).addGroup(
				sanpvTablePanelLayout.createSequentialGroup().addContainerGap()
						.addComponent(sanpvTableScrollPane, GroupLayout.DEFAULT_SIZE, 573, Short.MAX_VALUE)
						.addContainerGap()));
		sanpvTablePanelLayout.setVerticalGroup(sanpvTablePanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(
						sanpvTablePanelLayout.createSequentialGroup().addContainerGap()
								.addComponent(sanpvTableScrollPane, GroupLayout.DEFAULT_SIZE, 248, Short.MAX_VALUE)
								.addContainerGap()));
		...
		roiTablePanelLayout.setHorizontalGroup(roiTablePanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(
						roiTablePanelLayout.createSequentialGroup().addContainerGap()
								.addComponent(roiTableScrollPane, GroupLayout.DEFAULT_SIZE, 573, Short.MAX_VALUE)
								.addContainerGap()));
		roiTablePanelLayout.setVerticalGroup(roiTablePanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(
						roiTablePanelLayout.createSequentialGroup().addContainerGap()
								.addComponent(roiTableScrollPane, GroupLayout.DEFAULT_SIZE, 248, Short.MAX_VALUE)
								.addContainerGap()));
		...
		roiWaterfallPanelLayout.setHorizontalGroup(roiWaterfallPanelLayout.createParallelGroup(
				GroupLayout.Alignment.LEADING).addGroup(
				roiWaterfallPanelLayout.createSequentialGroup().addContainerGap()
						.addComponent(roiWaterfallTableScrollPane, GroupLayout.DEFAULT_SIZE, 573, Short.MAX_VALUE)
						.addContainerGap()));
		roiWaterfallPanelLayout.setVerticalGroup(roiWaterfallPanelLayout.createParallelGroup(
				GroupLayout.Alignment.LEADING).addGroup(
				roiWaterfallPanelLayout.createSequentialGroup().addContainerGap()
						.addComponent(roiWaterfallTableScrollPane, GroupLayout.DEFAULT_SIZE, 248, Short.MAX_VALUE)
						.addContainerGap()));
		...
		fileMenu.add(fileSeparator3);
		fileMenu.add(fileLoadProjectsRemotellyDataMenuItem);
		...
		layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addContainerGap()
						.addComponent(mainSplitPane, GroupLayout.DEFAULT_SIZE, 800, Short.MAX_VALUE).addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
				GroupLayout.Alignment.TRAILING,
				layout.createSequentialGroup().addContainerGap()
						.addComponent(mainSplitPane, GroupLayout.DEFAULT_SIZE, 600, Short.MAX_VALUE).addContainerGap()));
